...
return (
  <div className="min-h-screen flex items-center justify-center bg-gray-950 text-white px-4">
    <div className="bg-gray-900 p-8 rounded-xl shadow-md w-full max-w-xl">
      ...
      <form className="flex flex-col gap-4 w-full" onSubmit={handleSubmit}>
        <textarea
          ...
          className="w-full min-h-[9rem] resize-none p-3 rounded-md bg-gray-800 border border-gray-700 focus:outline-none focus:ring-2 focus:ring-indigo-500"
          required
        />
        <button
          type="submit"
